...
async def get_tunisian_radios():
    async with httpx.AsyncClient() as client:
        resp = await client.get(f"{RADIO_BROWSER_URL}/stations/bycountrycodeexact/TN", params={"limit": 50, "order": "clickcount", "reverse": "true"})
        return resp.json()

async def search_radios(query: str, country: str = None):
    params = {"limit": 30, "order": "clickcount", "reverse": "true", "hidebroken": "true"}
